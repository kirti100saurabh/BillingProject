...
public class DashBoard extends JPanel
{
	...
	{
		DashBoard.monthView = monthView;
	}
	
	
	
	
	public void populateDashBoard(EmployeeVO loggedInEmployee)
	{
		
		setNimbus();
		JFrame.setDefaultLookAndFeelDecorated(true);
		create(loggedInEmployee);
		//designLayout(loggedInEmployee);
		
	}
	private void designLayout(EmployeeVO loggedInEmployee)
	{
		setLayout(null);
		menubar=new JMenuBar();
		bak=new JLabel(new ImageIcon(DashBoard.class.getResource("/image/wall1.jpg")));
		...
		final JLabel myRef = new JLabel("By Tele-Teach Pvt Ltd.");
	...
	if(loggedInEmployee.getDeg()==1){
		...
		*/
		...
		btnPur.setIcon(new ImageIcon(DashBoard.class.getResource("/image/supp.png")));
		...
		/*
		 * Weekly sales report  icon is added and report is generated
		 */
		if(loggedInEmployee.getDeg()==1){
		btnSal = new JButton("");
		btnSal.setRolloverIcon(new ImageIcon(DashBoard.class.getResource("/image/sales1.png")));
		btnSal.setIcon(new ImageIcon(DashBoard.class.getResource("/image/salesRep.png")));
		...
		btnCustomer_1.setRolloverIcon(new ImageIcon(DashBoard.class.getResource("/image/"+str[0]+"1.png")));
		...
		btnCustomer_1.setIcon(new ImageIcon(DashBoard.class.getResource("/image/Customer.png")));
		...
		btnSuppler.setRolloverIcon(new ImageIcon(DashBoard.class.getResource("/image/"+str[1]+"1.png")));
		s="<html><strong style=\"font-family: Arial;font-size: 18px;\">"+"S"+"</strong>"+"upplier"+"</html>";
		btnSuppler.setContentAreaFilled(false);
		btnSuppler.setIcon(new ImageIcon(DashBoard.class.getResource("/image/Supplier.png")));
		...
		btnCompanyDetails.setRolloverIcon(new ImageIcon(DashBoard.class.getResource("/image/"+str[2]+"1.png")));
		...
		btnCompanyDetails.setIcon(new ImageIcon(DashBoard.class.getResource("/image/Company Details.png")));
		...
		btnStockAndPurchase.setRolloverIcon(new ImageIcon(DashBoard.class.getResource("/image/"+str[3]+"1.png")));
		...
		btnStockAndPurchase.setIcon(new ImageIcon(DashBoard.class.getResource("/image/Stock and Purchase.png")));
		...
		btnSales.setIcon(new ImageIcon(DashBoard.class.getResource("/image/Sale.png")));
	...
	/*private void setDates() {
		try {
			ResultSet rs=st.executeQuery("select distinct purch_date_time from purchase1");
	...
	public static void create(EmployeeVO loggedInEmployee)
	{
