...
public class StockAndPurchaseView extends JDialog {
	...
	static StockAndPurchaseView dialog;
	/**
	...
	public static void create() {
		dialog= new StockAndPurchaseView();
	...
	public StockAndPurchaseView() {
		...
		label.setIcon(new ImageIcon(StockAndPurchaseView.class.getResource("/images/guest1.gif")));
		...
		contentPanel.add(label);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.setIcon(new ImageIcon(StockAndPurchaseView.class.getResource("/images/continue.png")));
			...
			}
			{
				...
				cancelButton.setIcon(new ImageIcon(StockAndPurchaseView.class.getResource("/images/delete-icon1.png")));
